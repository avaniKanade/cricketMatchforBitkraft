            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-Result">
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('cruds.result.fields.winnerteam') }}
                        </th>
                        <th>
                            {{ trans('cruds.match.fields.result_1') }}
                        </th>
                        <th>
                            {{ trans('cruds.result.fields.second_team') }}
                        </th>
                        <th>
                ...
                <tbody>
                    @foreach($results as $key => $result)
                        <tr data-entry-id="{{ $result->id }}">
                            ...
                            <td>
                                {{ $result->winnerteam->start_game ?? '' }}
                            </td>
                            <td>
                                {{ $result->winnerteam->result_1 ?? '' }}
                            </td>
                            <td>
                                {{ $result->second_team->start_game ?? '' }}
                            </td>
                            <td>
                                {{ $result->second_team->result_2 ?? '' }}
                            </td>
                            <td>
                                @can('result_show')
